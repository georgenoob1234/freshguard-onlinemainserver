...
CATALOG: dict[str, dict[str, str]] = {
    ...
    "flash_membership_revoked": {"ru": "Членство отозвано.", "en": "Membership revoked."},
    "flash_store_created": {"ru": "Магазин создан.", "en": "Store created."},
    "flash_store_updated": {"ru": "Магазин обновлен.", "en": "Store updated."},
    "flash_device_decommissioned": {"ru": "Устройство выведено из эксплуатации.", "en": "Device decommissioned."},
    "flash_invite_revoked": {"ru": "Приглашение отозвано.", "en": "Invite revoked."},
    "flash_invite_minted": {"ru": "Приглашение создано.", "en": "Invite minted."},
    "flash_token_revoked": {"ru": "Токен отозван.", "en": "Token revoked."},
    ...
    "error_confirm_membership_revoke": {"ru": "Подтвердите отзыв членства.", "en": "Please confirm membership revoke."},
    "error_confirm_invite_minting": {"ru": "Подтвердите создание приглашения.", "en": "Please confirm invite minting."},
    "error_confirm_invite_revoke": {"ru": "Подтвердите отзыв приглашения.", "en": "Please confirm invite revoke."},
    "error_confirm_token_revoke": {"ru": "Подтвердите отзыв токена.", "en": "Please confirm token revoke."},
    "error_forbidden_action": {"ru": "Недостаточно прав для этого действия.", "en": "You do not have permission for this action."},
    "error_unknown_store": {"ru": "Магазин не найден.", "en": "Store not found."},
    "error_store_inactive_for_invite_minting": {
        "ru": "Для неактивного магазина нельзя создать приглашение.",
        "en": "Cannot mint an invite for an inactive store.",
    },
    "error_invalid_invite_role": {"ru": "Недопустимая роль приглашения.", "en": "Invalid invite role."},
    "error_invalid_invite_note": {"ru": "Недопустимое примечание приглашения.", "en": "Invalid invite note."},
    "error_invalid_invite_expires_at": {"ru": "Некорректная дата истечения.", "en": "Invalid expiration datetime."},
    "error_invalid_invite_max_uses": {"ru": "Некорректное значение max uses.", "en": "Invalid max uses value."},
    "error_invite_requires_limit": {
        "ru": "Нужно задать срок действия или максимум использований.",
        "en": "Set either expiration or max uses for this invite.",
    },
    ...
    "value_none": {"ru": "—", "en": "-"},
    "value_never": {"ru": "Никогда", "en": "Never"},
    "value_unlimited": {"ru": "Без ограничений", "en": "Unlimited"},
    ...
    "button_revoke_membership": {"ru": "Отозвать", "en": "Revoke"},
    # Stores list
    ...
    "status_decommissioned": {"ru": "Выведено", "en": "Decommissioned"},
    "status_revoked": {"ru": "Отозван", "en": "Revoked"},
    "status_expired": {"ru": "Истек", "en": "Expired"},
    "status_exhausted": {"ru": "Исчерпан", "en": "Exhausted"},
    ...
    "label_device_decommissioned": {"ru": "Выведено из эксплуатации:", "en": "Decommissioned:"},
    "confirm_device_decommission": {"ru": "Подтвердить вывод устройства из эксплуатации", "en": "Confirm device decommission"},
    "button_decommission_device": {"ru": "Вывести из эксплуатации", "en": "Decommission device"},
    "button_revoke": {"ru": "Отозвать", "en": "Revoke"},
    # Enroll tokens
    "mint_token_title": {"ru": "Выпустить токен регистрации", "en": "Mint Enroll Token"},
    "mint_invite_title": {"ru": "Создать приглашение", "en": "Mint staff invite"},
    "label_expires_sec": {"ru": "Истекает через (сек)", "en": "Expires in seconds"},
    "label_max_uses": {"ru": "Максимум использований", "en": "Max uses"},
    "label_invite_expires_at_optional": {"ru": "Истекает (дата и время)", "en": "Expires at (date and time)"},
    "label_invite_max_uses_optional": {"ru": "Максимум использований", "en": "Max uses"},
    "label_note": {"ru": "Примечание", "en": "Note"},
    "placeholder_note_optional": {"ru": "Необязательно", "en": "Optional"},
    "placeholder_optional_empty": {"ru": "оставьте пустым", "en": "leave empty"},
    "confirm_token_minting": {"ru": "Подтвердить выпуск токена", "en": "Confirm token minting"},
    "confirm_invite_minting": {"ru": "Подтвердить создание приглашения", "en": "Confirm invite minting"},
    "button_mint_token": {"ru": "Выпустить токен", "en": "Mint token"},
    "button_mint_invite": {"ru": "Создать приглашение", "en": "Mint invite"},
    "section_enroll_tokens_list": {"ru": "Токены", "en": "Enroll tokens"},
    "section_staff_invites": {"ru": "Приглашения персонала", "en": "Staff invites"},
    "table_invite_id": {"ru": "ID приглашения", "en": "Invite ID"},
    "table_token_id": {"ru": "ID токена", "en": "Token ID"},
    "table_status_short": {"ru": "Статус", "en": "Status"},
    "table_uses": {"ru": "Использования", "en": "Uses"},
    "table_expires_at": {"ru": "Истекает", "en": "Expires at"},
    "empty_no_invites": {"ru": "Приглашений нет.", "en": "No invites."},
    "empty_no_enroll_tokens": {"ru": "Токенов нет.", "en": "No enroll tokens."},
    "created_token_title": {"ru": "Созданный токен", "en": "Created token"},
    "created_invite_title": {"ru": "Созданное приглашение", "en": "Created invite"},
    ...
    "copy_now_invite_message": {
        "ru": "Этот код приглашения показывается только сейчас. Скопируйте его сразу.",
        "en": "This invite code is shown only on this response. Copy it now.",
    },
    "hint_invite_limit_required": {
        "ru": "Для обычных OMS пользователей нужен хотя бы один лимит: срок или max uses.",
        "en": "For regular OMS users, set at least one limit: expiration or max uses.",
    },
    "hint_bootstrap_unlimited_invite": {
        "ru": "Bootstrap администратор может оставить оба лимита пустыми.",
        "en": "Bootstrap admin may leave both limits empty.",
    },
    ...
    "button_go_to_admin_login": {"ru": "Открыть страницу входа", "en": "Open login page"},
